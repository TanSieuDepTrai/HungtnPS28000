...
namespace DuAn1.UI
{
    public partial class FormHi : Form
    {
        // Fields
        ...
        private void FormHi_Load(object sender, EventArgs e)
        {
        ...
        {
            OpenChildForm(new UI.Login(), sender);
            label1.Text = btDangNhap.Text;
        }

        private void btQuenMatKhau_Click(object sender, EventArgs e)
        {
            OpenChildForm(new UI.QuenMatKhau(), sender);
            label1.Text = btQuenMatKhau.Text;
        }

        private void btDoiMatKhau_Click(object sender, EventArgs e)
        {
            OpenChildForm(new UI.DoiMatKhau(), sender);
